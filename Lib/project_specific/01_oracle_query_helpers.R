...
if(sys.nframe() == 0) file.edit("Path_dependent_files/./Lib/project_specific/01_oracle_query_helpers.R")
##   --- --- --- --- --- --- --- --- --- --- 
...
launch_sql_job <- function(sql_file) {
  ...
  sh(
    str_c("sed 's:<path-to-file>:", sql_file,
          ":' /sasdata/prd/users/42a001092210899/sasuser/RStudio_projects/_SNDS_TOOLS/Lib/script_helpers/launch-sql-jobs-script.R > ",
          temp_path ))
